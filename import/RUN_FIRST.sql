...
GRANT ALL ON SCHEMA STAGING TO ROLE SNOWFLAKE_LEARNING_ROLE;
GRANT CREATE STAGE ON SCHEMA STAGING TO ROLE SNOWFLAKE_LEARNING_ROLE;
GRANT CREATE FILE FORMAT ON SCHEMA STAGING TO ROLE SNOWFLAKE_LEARNING_ROLE;
GRANT CREATE TABLE ON SCHEMA STAGINGTO ROLE SNOWFLAKE_LEARNING_ROLE;
GRANT SELECT ON ALL TABLES IN SCHEMA FEC.STAGING TO ROLE SNOWFLAKE_LEARNING_ROLE;
